      ...
      <div className="relative z-10 max-w-[1450px] mx-auto px-5 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-[1.1fr_1.4fr] gap-8 sm:gap-10 md:gap-14 lg:gap-20 items-center">
          ...
          >
            ...
            <div className="overflow-hidden rounded-[30px] md:rounded-[40px] bg-[#102A5E] aspect-[4/5]">
              <img
                src="/corres.jpg"
          ...
          >
            ...
            <div className="w-16 sm:w-20 md:w-24 h-[3px] bg-[#C89B3C] rounded-full mt-6 sm:mt-8 md:mt-10" />
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5 lg:gap-6 mt-12 sm:mt-16 md:mt-20 lg:mt-28">
          {[
            ...
            <motion.div
              ...
              className={`
                border border-white/10 rounded-[20px] sm:rounded-[24px] md:rounded-[30px] p-5 sm:p-6 md:p-8 lg:p-10 bg-white/[0.03] hover:bg-white/[0.06] transition duration-500
